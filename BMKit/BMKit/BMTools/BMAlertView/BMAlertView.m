...
#define BMAlertViewMaskBgDefaultEffect  [UIBlurEffect effectWithStyle:UIBlurEffectStyleLight]

#define BMAlertViewMaskBgColor          [UIColor colorWithWhite:0 alpha:0.25]
...
@property (nonatomic, strong) UIVisualEffectView *alertMaskBgEffectView;
...
@synthesize alertMaskBgColor = _alertMaskBgColor;
                  ...
                  completion:(BMAlertViewCompletionBlock)completion
{
    ...
    if (self)
    {
        ...
        {
            [btnTitles addObject:BMKitLocalized(@"Prompt.OK", nil)];
        }
        ...
        self.alertMaskBgEffect = BMAlertViewMaskBgDefaultEffect;
        self.alertMaskBgEffectView = [[UIVisualEffectView alloc] initWithEffect:self.alertMaskBgEffect];
        self.alertMaskBgEffectView.alpha = 0.8f;
        self.alertMaskBgEffectView.backgroundColor = [UIColor clearColor];
        self.alertMaskBgEffectView.frame = self.view.bounds;
        [self.view addSubview:self.alertMaskBgEffectView];
        
        self.backgroundView = [[UIView alloc] initWithFrame:frame];
        self.backgroundView.backgroundColor = self.alertMaskBgColor;
...
- (void)freshAlertView
{
    ...
    self.alertMaskBgEffectView.effect = self.alertMaskBgEffect;
    ...
    self.alertView.center = [self centerWithFrame:self.alertMaskBgEffectView.bounds];
}

- (void)centerAlertView
{
    CGRect frame = [self frameForOrientation];
    self.alertMaskBgEffectView.frame = frame;
...
- (void)setAlertMaskBgEffect:(UIVisualEffect *)alertMaskBgEffect
{
    _alertMaskBgEffect = alertMaskBgEffect;
    
    self.alertMaskBgEffectView.effect = alertMaskBgEffect;
}
...
- (UIColor *)alertMaskBgColor
{
    if (!_alertMaskBgColor)
    {
        return BMAlertViewMaskBgColor;
    }
    
    return _alertMaskBgColor;
}

- (void)setAlertMaskBgColor:(UIColor *)alertMaskBgColor
{
    _alertMaskBgColor = alertMaskBgColor;
    
    self.backgroundView.backgroundColor = alertMaskBgColor;
}
