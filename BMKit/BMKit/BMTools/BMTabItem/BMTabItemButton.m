...
- (void)setNormalIconUrl:(NSString *)normalIconUrl
{
    ...
    [self bmsd_setImageWithURL:[NSURL URLWithString:newURL] host:nil forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:self.normalIcon]];
}
...
- (void)setSelectedIconUrl:(NSString *)selectedIconUrl
{
    ...
    [self bmsd_setImageWithURL:[NSURL URLWithString:newURL] host:nil forState:UIControlStateSelected placeholderImage:[UIImage imageNamed:self.selectedIcon]];
}
...
- (void)setHighlightIconUrl:(NSString *)highlightIconUrl
{
    ...
    [self bmsd_setImageWithURL:[NSURL URLWithString:newURL] host:nil forState:UIControlStateHighlighted placeholderImage:[UIImage imageNamed:self.highlightIcon]];
}
