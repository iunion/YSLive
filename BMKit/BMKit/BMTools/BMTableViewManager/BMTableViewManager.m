...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (self.style.animationStyle)
    {
        case UITableViewCellAnimationStyle_Rotate:
        {
            NSIndexPath *topIndexPath = indexPath;
            NSArray<NSIndexPath *> *indexPathsForVisibleRows = [tableView indexPathsForVisibleRows];
            if ([indexPathsForVisibleRows bm_isNotEmpty])
            {
                topIndexPath = indexPathsForVisibleRows[0];
            }
            
            CATransform3D rotate;
            
            CGFloat value = (90.0f * M_PI) / 180.0f;
            
            if (topIndexPath.row == indexPath.row)
            {
        ...
        case UITableViewCellAnimationStyle_Scale:
        {
            cell.transform = CGAffineTransformScale(cell.transform, 0.5, 0.5);
            
            [UIView beginAnimations:@"scal" context:nil];
            UIView.animationDuration = 0.6f;
            ...
            // fresh bug
        case UITableViewCellAnimationStyle_ScalePoint:
        {
            ...
            [cell.layer addAnimation:scaleAnimation forKey:@"scal"];
        }
            break;
        ...
        case UITableViewCellAnimationStyle_Alpha:
        {
            cell.alpha = 0.0f;
        ...
        case UITableViewCellAnimationStyle_Fall:
        {
            NSIndexPath *topIndexPath = indexPath;
            NSArray<NSIndexPath *> *indexPathsForVisibleRows = [tableView indexPathsForVisibleRows];
            if ([indexPathsForVisibleRows bm_isNotEmpty])
            ...
            if (topIndexPath.row == indexPath.row)
            {
                cell.transform = CGAffineTransformMakeTranslation(0, cell.bm_height);
            }
            else
            {
                cell.transform = CGAffineTransformMakeTranslation(0, -cell.bm_height);
        ...
        case UITableViewCellAnimationStyle_LeftRightOverTurn:
        {
            ...
            if (topIndexPath.row == indexPath.row)
            {
                cell.layer.transform = CATransform3DMakeRotation(M_PI, 0, 1, -0.2);
            }
            else
            {
                cell.layer.transform = CATransform3DMakeRotation(M_PI, 0, 1, 0.2);
        ...
        case UITableViewCellAnimationStyle_UpDownOverTurn:
        {
            cell.layer.opacity = 0.0;
        ...
        case UITableViewCellAnimationStyle_None:
        default:
            break;
    }
}
...
- (NSString *)tableView:(UITableView *)tableView titleForDeleteConfirmationButtonForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return BMKitLocalized(@"ToolBar.Delete", @"Delete");
}
