...
- (void)cellWillAppear
{
    ...
    {
        [self.detailImageView bmsd_setImageWithURL:[NSURL URLWithString:self.item.detailImageUrl]
                                              host:nil
                                         completed:^(UIImage *image, NSError *error, BMSDImageCacheType cacheType, NSURL *imageURL)
         {
             [self setNeedsLayout];
