...
{
    return [[BMBoolItem alloc] initWithTitle:title value:value];
}
...
{
    return [[BMBoolItem alloc] initWithTitle:title value:value switchValueChangeHandler:valueChangeHandler];
}
