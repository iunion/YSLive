...
- (instancetype)initWithDelegate:(id<BMTableViewActionBarDelegate>)delegate
{
    ...
    self.navigationControl = [[UISegmentedControl alloc] initWithItems:[NSArray arrayWithObjects:BMKitLocalized(@"ToolBar.Previous", @""), BMKitLocalized(@"ToolBar.Next", @""), nil]];
