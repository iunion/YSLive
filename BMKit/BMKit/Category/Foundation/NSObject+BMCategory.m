...
@implementation NSObject (BMJson)

- (NSDictionary *)bm_toDictionary
{
...
- (NSData *)bm_toJSONDataWithOptions:(NSJSONWritingOptions)options error:(NSError **)error
{
    return [NSJSONSerialization dataWithJSONObject:[self bm_toDictionary] options:options error:error];
}

- (id)bm_objectInternal
{
    ...
    if ([self isKindOfClass:[NSArray class]])
    {
        ...
        {
            [arr setObject:[[objarr objectAtIndex:i] bm_objectInternal] atIndexedSubscript:i];
        }
        return arr;
    }
    ...
    if([self isKindOfClass:[NSDictionary class]])
    {
        ...
        {
            [dic setObject:[[objdic objectForKey:key] bm_objectInternal] forKey:key];
        }
        return dic;
    }
    
    return [self bm_toDictionary];
}
