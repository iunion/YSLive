...
#pragma clang diagnostic pop
        ...
        case FamilyFontNameZapfino:
            ...
            break;
        case FamilyFontNamePingFangSC:
            fontNames = [UIFont fontNamesForFamilyName:@"PingFangSC"];
            break;
    }
...
#pragma clang diagnostic pop
        ...
        case FontNameZapfino:
            return @"Zapfino";
        case FontNamePingFangSCMedium:
            return @"PingFang-SC-Medium";
        case FontNamePingFangSCSemibold:
            return @"PingFang-SC-Semibold";
        case FontNamePingFangSCLight:
            return @"PingFang-SC-Light";
        case FontNamePingFangSCUltralight:
            return @"PingFang-SC-Ultralight";
        case FontNamePingFangSCRegular:
            return @"PingFang-SC-Regular";
        case FontNamePingFangSCThin:
            return @"PingFang-SC-Thin";
        default:
            return nil;
    }
}
