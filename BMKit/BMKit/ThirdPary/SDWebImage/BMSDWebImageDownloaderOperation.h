...
FOUNDATION_EXPORT NSString * _Nonnull const BMSDWebImageDownloadReceiveResponseNotification;
FOUNDATION_EXPORT NSString * _Nonnull const BMSDWebImageDownloadStopNotification;
FOUNDATION_EXPORT NSString * _Nonnull const BMSDWebImageDownloadFinishNotification;
 ...
 */
@protocol BMSDWebImageDownloaderOperationInterface<NSObject>
...
@interface BMSDWebImageDownloaderOperation : NSOperation <BMSDWebImageDownloaderOperationInterface, BMSDWebImageOperation, NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
