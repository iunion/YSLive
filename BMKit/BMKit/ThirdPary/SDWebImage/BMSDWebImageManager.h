...
typedef NS_OPTIONS(NSUInteger, BMSDWebImageOptions) {
     ...
     */
    BMSDWebImageCacheMemoryOnly = 1 << 2,

    /**
     * This flag enables progressive download, the image is displayed progressively during download as a browser would do.
     * By default, the image is only displayed once completely downloaded.
     */
    BMSDWebImageProgressiveDownload = 1 << 3,
     ...
     */
    BMSDWebImageRefreshCached = 1 << 4,

    /**
     * In iOS 4+, continue the download of the image if the app goes to background. This is achieved by asking the system for
     * extra time in background to let the request finish. If the background task expires the operation will be cancelled.
     */
    BMSDWebImageContinueInBackground = 1 << 5,

    /**
     * Handles cookies stored in NSHTTPCookieStore by setting
     * NSMutableURLRequest.HTTPShouldHandleCookies = YES;
     */
    BMSDWebImageHandleCookies = 1 << 6,

    /**
     * Enable to allow untrusted SSL certificates.
     * Useful for testing purposes. Use with caution in production.
     */
    BMSDWebImageAllowInvalidSSLCertificates = 1 << 7,

    /**
     * By default, images are loaded in the order in which they were queued. This flag moves them to
     * the front of the queue.
     */
    BMSDWebImageHighPriority = 1 << 8,
    
    /**
     * By default, placeholder images are loaded while the image is loading. This flag will delay the loading
     * of the placeholder image until after the image has finished loading.
     */
    BMSDWebImageDelayPlaceholder = 1 << 9,
     ...
     */
    BMSDWebImageTransformAnimatedImage = 1 << 10,
     ...
     */
    BMSDWebImageAvoidAutoSetImage = 1 << 11,
 ...
 */
- (BOOL)imageManager:(nonnull BMSDWebImageManager *)imageManager shouldDownloadImageForURL:(nullable NSURL *)imageURL;
 ...
 */
- (nullable UIImage *)imageManager:(nonnull BMSDWebImageManager *)imageManager transformDownloadedImage:(nullable UIImage *)image withURL:(nullable NSURL *)imageURL;
...
@property (strong, nonatomic, readonly, nullable) BMSDImageCache *imageCache;
@property (strong, nonatomic, readonly, nullable) BMSDWebImageDownloader *imageDownloader;
 ...
 */
- (nonnull instancetype)initWithCache:(nonnull BMSDImageCache *)cache downloader:(nonnull BMSDWebImageDownloader *)downloader NS_DESIGNATED_INITIALIZER;
