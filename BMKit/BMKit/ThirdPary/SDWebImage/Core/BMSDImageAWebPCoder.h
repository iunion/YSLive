...
@interface BMSDImageAWebPCoder : BMSDImageIOAnimatedCoder <BMSDProgressiveImageCoder, BMSDAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) BMSDImageAWebPCoder *sharedCoder;
