...
@interface BMSDWebImageDownloaderResponseModifier ()

@property (nonatomic, copy, nonnull) BMSDWebImageDownloaderResponseModifierBlock block;

@end

@implementation BMSDWebImageDownloaderResponseModifier

- (instancetype)initWithBlock:(BMSDWebImageDownloaderResponseModifierBlock)block {
    self = [super init];
    if (self) {
        self.block = block;
    }
...
+ (instancetype)responseModifierWithBlock:(BMSDWebImageDownloaderResponseModifierBlock)block {
    BMSDWebImageDownloaderResponseModifier *responseModifier = [[BMSDWebImageDownloaderResponseModifier alloc] initWithBlock:block];
...
@implementation BMSDWebImageDownloaderResponseModifier (Conveniences)
