...
#define kBMSDUTTypeHEIC ((__bridge CFStringRef)@"public.heic")
#define kBMSDUTTypeHEIF ((__bridge CFStringRef)@"public.heif")
// HEIC Sequence (Animated Image)
#define kBMSDUTTypeHEICS ((__bridge CFStringRef)@"public.heics")
// kUTTypeWebP seems not defined in public UTI framework, Apple use the hardcode string, we define them :)
#define kBMSDUTTypeWebP ((__bridge CFStringRef)@"org.webmproject.webp")

@interface BMSDImageIOAnimatedCoder ()
