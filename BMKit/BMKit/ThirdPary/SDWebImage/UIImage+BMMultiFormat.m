...
+ (nullable UIImage *)bm_imageWithData:(nullable NSData *)data {
    ...
    {
        image = [UIImage bm_imageWithWebPData:data];
    }
#endif
    else {
        image = [[UIImage alloc] initWithData:data];
#if SD_UIKIT || SD_WATCH
        UIImageOrientation orientation = [self bm_imageOrientationFromImageData:data];
...
#if SD_UIKIT || SD_WATCH
+(UIImageOrientation)bm_imageOrientationFromImageData:(nonnull NSData *)imageData {
    ...
    if (imageSource) {
        ...
        if (properties) {
            ...
            if (val) {
                ...
                result = [self bm_exifOrientationToiOSOrientation:exifOrientation];
...
+ (UIImageOrientation) bm_exifOrientationToiOSOrientation:(int)exifOrientation {
