...
@interface BMTZGifPhotoPreviewController () {
    UIView *_toolBar;
    UIButton *_doneButton;
    UIProgressView *_progress;
    
    BMTZPhotoPreviewView *_previewView;
...
@implementation BMTZGifPhotoPreviewController
...
- (void)configBottomToolBar {
    ...
    [[BMTZImageManager manager] getPhotosBytesWithArray:@[_model] completion:^(NSString *totalBytes) {
