...
@implementation BMTZImageRequestOperation
...
- (void)start {
    self.executing = YES;
    [[BMTZImageManager manager] getPhotoWithAsset:self.asset completion:^(UIImage *photo, NSDictionary *info, BOOL isDegraded) {
