...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        for (int i = 0; i < [SCColorSelectView colorArray].count; i ++) {
            ...
            colorView.backgroundColor = [CHCommonTools colorWithHexString:[[SCColorSelectView colorArray] objectAtIndex:i]];
...
- (void) selectorViewPan:(UIPanGestureRecognizer *)pan {
    ...
    if (pan.state == UIGestureRecognizerStateBegan || pan.state == UIGestureRecognizerStateChanged) {
        ...
        self.chooseTipView.hidden = YES;
        self.colorTipView.hidden  = YES;
        self.currentColorView.backgroundColor = [CHCommonTools colorWithHexString:self.currentColor];
    }
}
...
- (void) showColorTipWithIndex:(NSInteger)index {
    ...
    self.currentColorView.backgroundColor = [CHCommonTools colorWithHexString:chooseColor];
...
- (void)setCurrentSelectColor:(NSString *)curColor {
    ...
    self.currentColorView.backgroundColor = [CHCommonTools colorWithHexString:curColor];
