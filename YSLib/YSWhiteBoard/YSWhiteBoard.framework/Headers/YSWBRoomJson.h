...
@class YSWBRoomConfiguration;


@interface YSWBRoomJson : NSObject
...
/**
 配置项
 */
@property (nonatomic, strong)YSWBRoomConfiguration *configuration;
...
//配置项
@interface YSWBRoomConfiguration : NSObject
