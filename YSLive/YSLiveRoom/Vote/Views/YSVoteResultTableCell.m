...
- (void)layoutSubviews
{
    ...
    if (f > 0.9 )
    {
        self.numPersonLabel.textColor = [UIColor bm_colorWithHex:0xFFFFFF];
    }
...
- (UILabel *)titleL
{
    if (!_titleL)
    {
        ...
        _titleL.textColor = [UIColor bm_colorWithHex:0x828282];
...
- (UILabel *)numPersonLabel
{
    if (!_numPersonLabel)
    {
        ...
        _numPersonLabel.textColor = [UIColor bm_colorWithHex:0x828282];
