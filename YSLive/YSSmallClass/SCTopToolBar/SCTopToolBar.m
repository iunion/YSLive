...
//    [self.signalLamp bmmas_makeConstraints:^(BMMASConstraintMaker *make) {
//        make.centerY.bmmas_equalTo(0);
//        make.left.bmmas_equalTo(weakSelf.roomIDL.mas_right).mas_offset(10);
//        make.width.height.bmmas_equalTo(16);
//    }];
...
//    [self.timeImgView bmmas_makeConstraints:^(BMMASConstraintMaker *make) {
//        make.centerY.bmmas_equalTo(0);
