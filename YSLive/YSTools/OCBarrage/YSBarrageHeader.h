...
#define kYSBarrageAnimation @"kYSBarrageAnimation"
...
typedef NS_ENUM(NSUInteger, YSBarragePositionPriority)
{
...
typedef NS_ENUM(NSUInteger, YSBarrageRenderPositionStyle)
{// 新加的cell的y坐标的类型
