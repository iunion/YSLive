...
//  YSAll
//
//  Created by jiang deng on 2020/7/17.
...
@implementation BMPerformTest

/** 单例 */
+ (instancetype)shareInstance
{
    static BMPerformTest *instance;
...
+ (void)monitorThreadEntryPoint
{
    @autoreleasepool
    {
        [[NSThread currentThread] setName:@"PerformTest"];
...
{
    BMPerformTest *monitor = (__bridge BMPerformTest *)info;
    if (!monitor.isExcuting)
    {  // 即 runloop 已经进入了休眠 kCFRunLoopBeforeWaiting
        return;
    }
